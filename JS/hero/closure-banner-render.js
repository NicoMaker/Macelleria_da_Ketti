// ─────────────────────────────────────────────────────────────────────────────
// closure-banner-render.js — Mostra il banner chiusure nella hero section
// Mostra automaticamente le chiusure imminenti o attive
// Dipende da: closure-banner-wait-for-data.js, json-loader.js, app-config.js
// ─────────────────────────────────────────────────────────────────────────────

HeroClosureBanner.render = function () {
  ...
  JsonData.load(AppConfig.footer.jsonKey)
    .then(function (data) {
      ...
      if (activeClosure) {
        const motivoText =
          activeClosure.motivo !== "Ferie" ? ` - ${activeClosure.motivo}` : "";
